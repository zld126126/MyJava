...
public class RedisReadConfiguration {
    ...
    public StringRedisTemplate redisTemplate(@Value("${spring.redis-read.host}") String hostName,
                                             @Value("${spring.redis-read.port}") int port,
                                             @Value("${spring.redis-read.password}") String password,
                                             @Value("${spring.redis-read.testOnBorrow}") boolean testOnBorrow,
